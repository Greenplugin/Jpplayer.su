              ...
              <div class="about-block">
                <div class="uk-grid">
                  ...
                  <div class="uk-width-small-1-1 uk-width-medium-1-1 uk-width-large-2-3">
                    <article>
                      <h3>В Telegram</h3>
                      У нас есть Telegram бот, который может выдавать Вам ключики прямо в мессенджер, кстати
                      регистрируясь на сайте через Telegram, вы получите пять разблокировок для clarion вместо трех при
                      обычной регистрации
                    </article>
                  </div>
                </div>
              ...
              <div class="about-block">
                <div class="uk-grid">
                  ...
                  <div class="uk-width-small-1-1 uk-width-medium-1-1 uk-width-large-2-3">
                    <article>
                      <h3>На сайте</h3>
                      После регистрации Вы сможете разблокировать любое количество устройств по ERC коду а так же
                      некоторое количество устройств Clarion.
                    </article>
                  </div>
                </div>
              </div>
